...
urlpatterns = [
        ...
        path('download_audio/<audio_id>', views.download_audio, name='download-audio'),
        path('download_config/<config_id>', views.download_config, name='download-config'),
        path('upload_config/', views.upload_config, name='upload-config'),
        path('upload_audio/', views.upload_audio, name='upload-audio'),
