...
void InitMcBSPb()
{
    ...
    McbspbRegs.RCR2.bit.RWDLEN2 = 0;  //DSP = 0
    McbspbRegs.RCR1.bit.RWDLEN1 = 5;
    McbspbRegs.XCR2.bit.XWDLEN2 = 0;  //DSP = 0
    McbspbRegs.XCR1.bit.XWDLEN1 = 5;
    McbspbRegs.RCR2.bit.RPHASE = 0; // Dual-phase frame for receive || DSP = 0
    ...
    McbspbRegs.XCR2.bit.XPHASE = 0; // Dual-phase frame for transmit || DSP = 0
    ...
    // I2S mode: R/XDATDLY = 1 always //DSP mode: R/XDATDLY = 0
